...
class PackwizProxyController extends Controller
{
    ...
    public function items(Request $request,Server $server,string $project):Response{$this->authorizeServer($request,$server);return $this->relay($this->service($request,'packwiz.read')->get("/projects/{$project}/items"));}
