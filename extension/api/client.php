...
use Pterodactyl\BlueprintFramework\Extensions\packwizmanager\PackwizFileController;
...
Route::get('/servers/{server}/projects/{project}/files/download', [PackwizFileController::class, 'download']);
